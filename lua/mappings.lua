...
map("n", ",,h", vim.lsp.buf.signature_help, "Signature")
...
map("t", "<Esc><Esc>", function()
  utils.ExitTerminalMode()
end, "Exit terminal mode")
map("t", ",,o", function()
  utils.SwitchToFileWindow()
end, "Switch to to source file window")
map("t", ",,s", function()
  utils.SwitchToOutline()
end, "Switch to outline window")
map("t", ",,e", function()
  utils.ExitTerminalMode()
  utils.SwitchToFileTree()
